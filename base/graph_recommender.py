...
class GraphRecommender(Recommender):
    def __init__(self, conf, training_set, test_set, **kwargs):
        ...
        self.data = Interaction(conf, training_set, test_set)  # Interaction class inherits from Data and Graph
    ...
    def fast_evaluation(self, epoch):
        ...
        print('*Current Performance*')
        print('Epoch:', str(epoch + 1) + ',', '  |  '.join(measure))
        self.model_log.add('*Current Performance*')
        temp='Epoch:' + str(epoch + 1) + ','+ '  |  '.join(measure)
        self.model_log.add(temp)
        bp = ''
        # for k in self.bestPerformance[1]:
        #     bp+=k+':'+str(self.bestPerformance[1][k])+' | '
        bp += 'Hit Ratio' + ':' + str(self.bestPerformance[1]['Hit Ratio']) + '  |  '
        ...
        temp='Epoch:'+str(self.bestPerformance[0]) + ','+bp
        self.model_log.add(temp)
        self.model_log.add('-' * 80)
